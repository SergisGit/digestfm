(function () {
  'use strict';
    ...
    function gMap(container) {
      var markLatLng = new google.maps.LatLng(56.47405206824914,84.98736349999993);
      var mapOptions = {
        zoom: 16,
        center: markLatLng,
    ...
    if (map) {
      google.maps.event.addDomListener(window, 'load', gMap(map));
    }
